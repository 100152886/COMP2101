...
echo "============="
#i tried for a long time to figure this out, using all of the slides and
#as much as i could find on google. im sure theyre wrong, but this is what i
#came up with.

#find ~/ -type f -executable -perm -6000 -ls 2>/dev/null | du -m | sort -n -r | head -n 10
find / -type f 2>/dev/null | du -m | sort -n -r | head -n 10
